(function () {
  ...
  const I18N = {
    vi: {
      ...
      subtitleDashboard: 'Ch\u1ec9 t\u1ea3i s\u1ed1 li\u1ec7u v\u00e0 c\u1ea3nh b\u00e1o c\u1ea7n thi\u1ebft cho dashboard',
      titleConversations: 'H\u1ed9i tho\u1ea1i',
      subtitleConversations: 'Page ri\u00eang ch\u1ec9 t\u1ea3i danh s\u00e1ch v\u00e0 h\u1ed9i tho\u1ea1i \u0111ang m\u1edf',
      titleAlerts: 'C\u1ea3nh b\u00e1o',
      subtitleAlerts: 'Th\u00f4ng b\u00e1o c\u1ea7n nh\u00e2n vi\u00ean ki\u1ec3m tra',
      titleImprovements: 'C\u1ea7n c\u1ea3i thi\u1ec7n',
      subtitleImprovements: 'C\u00e1c ph\u1ea3n h\u1ed3i AI \u0111\u00e3 \u0111\u01b0\u1ee3c \u0111\u00e1nh d\u1ea5u c\u1ea7n xem l\u1ea1i',
      titleKnowledge: 'Training',
      subtitleKnowledge: 'M\u1ed7i ngu\u1ed3n training \u0111\u01b0\u1ee3c t\u1ea3i ri\u00eang, kh\u00f4ng k\u00e9o theo h\u1ed9i tho\u1ea1i hay log',
      titleLogs: 'Nh\u1eadt k\u00fd',
      subtitleLogs: 'T\u00e1ch ri\u00eang log \u0111\u1ec3 kh\u00f4ng render chung v\u1edbi h\u1ed9i tho\u1ea1i',
      login: '\u0110\u0103ng nh\u1eadp',
    ...
    en: {
      ...
      subtitleDashboard: 'Only load the metrics and alerts needed for the dashboard',
      titleConversations: 'Conversations',
      subtitleConversations: 'A separate page for conversation list and the selected thread',
      titleAlerts: 'Alerts',
      subtitleAlerts: 'Notifications that need staff review',
      titleImprovements: 'Improvements',
      subtitleImprovements: 'AI replies marked for review',
      titleKnowledge: 'Training',
      subtitleKnowledge: 'Load each training source separately without conversations or logs',
      titleLogs: 'Logs',
      subtitleLogs: 'Logs are split out to avoid rendering them with conversations',
      login: 'Login',
    ...
    zh: {
      ...
      navLogs: '\u65e5\u5fd7',
      titleDashboard: '\u603b\u89c8',
      subtitleDashboard: '\u4ec5\u52a0\u8f7d\u4eea\u8868\u677f\u9700\u8981\u7684\u6570\u636e\u548c\u63d0\u9192',
      titleConversations: '\u4f1a\u8bdd',
      subtitleConversations: '\u72ec\u7acb\u9875\u9762\uff0c\u53ea\u52a0\u8f7d\u5217\u8868\u548c\u5f53\u524d\u4f1a\u8bdd',
      titleAlerts: '\u63d0\u9192',
      subtitleAlerts: '\u9700\u8981\u5458\u5de5\u68c0\u67e5\u7684\u901a\u77e5',
      titleImprovements: '\u5f85\u6539\u8fdb',
      subtitleImprovements: '\u5df2\u6807\u8bb0\u9700\u8981\u590d\u6838\u7684 AI \u56de\u590d',
      titleKnowledge: '\u8bad\u7ec3',
      subtitleKnowledge: '\u6bcf\u4e2a\u8bad\u7ec3\u6765\u6e90\u5355\u72ec\u52a0\u8f7d\uff0c\u4e0d\u540c\u65f6\u52a0\u8f7d\u4f1a\u8bdd\u6216\u65e5\u5fd7',
      titleLogs: '\u65e5\u5fd7',
      subtitleLogs: '\u65e5\u5fd7\u72ec\u7acb\u663e\u793a\uff0c\u907f\u514d\u4e0e\u4f1a\u8bdd\u4e00\u8d77\u6e32\u67d3',
      login: '\u767b\u5f55',
