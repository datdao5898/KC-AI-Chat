  ...
  const guides = {
    ...
    en: {
      ...
      sections: [
        ...
        { id: 'conversations', title: 'Manage conversations', summary: 'Handle Facebook, Zalo and website customers in one place.', steps: ['Choose a channel, then select the page or website.', 'Auto ON means AI can reply; Auto OFF means staff handles the chat.', 'Needs staff means the system has raised an alert.', 'Website staff can send text replies from the conversation.', 'Mark wrong stores an AI reply for review.', 'Deleting a conversation permanently removes its data.'], link: '/admin/conversations.html', linkLabel: 'Open Conversations' },
        ...
        { id: 'widget', title: 'Website widget', summary: 'KingCom and NewLite share the app but keep separate branding and knowledge.', steps: ['KingCom uses data-site-name="kingcom" and #007f7b.', 'NewLite uses data-site-name="newlite" and #ff2d94.', 'Customers can send text and optional contact details.', 'Website messages appear under the matching Website source.', 'Staff text replies return to the customer widget.'], code: '<script src="https://ai.kingcom.com.vn/widget.js" data-site-name="newlite"></script>' },
        { id: 'troubleshooting', title: 'Troubleshooting', summary: 'Basic checks before changing code or training.', steps: ['No incoming messages: check the app, public domain and webhook URL.', 'No reply: inspect Logs for provider, database or AI Judge errors.', 'Wrong product: verify the source, catalog and page brand.', 'Unknown policy: add a clear answer to the correct FAQ or Policies file.', 'Too many requests: wait one minute; rate limiting protects against spam.'], link: '/admin/logs.html', linkLabel: 'Open Logs' },
    ...
    zh: {
      ...
      sections: [
        ...
        { id: 'troubleshooting', title: '问题排查', summary: '修改代码或训练前的基础检查。', steps: ['没有收到消息：检查应用、公开域名和 webhook 地址。', '没有回复：在日志中检查模型、数据库或 AI Judge 错误。', '产品错误：检查来源、产品目录和主页品牌。', '政策不清楚：在正确来源的 FAQ 或政策中补充明确答案。', '请求过多：等待一分钟，限流功能用于防止垃圾请求。'], link: '/admin/logs.html', linkLabel: '打开日志' },
