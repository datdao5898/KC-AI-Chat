...
function classifyIntent(text) {
  ...
  if (hasWord(msg, ['hello','hi']) || hasPhrase(msg, ['xin chao','chao ban','chao shop','em chao','alo'])) return { intent: 'greeting', confidence: 0.9 };
  ...
  if (hasPhrase(msg, ['tư vấn','san pham','sản phẩm']) || hasWord(msg, ['tìm','tim','lens','micro','đèn','den','camera','ulanzi','synco','zhiyun','viltrox','nanlite','samsung','gimbal','filter','kase','boya','fifine','maono','bộ','bo','đàm','dam'])) return { intent: 'product_search', confidence: 0.85 };
